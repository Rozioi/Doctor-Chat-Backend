...
1️⃣ **СТАРТ** 🟢
Нажмите кнопку «Получить экспертизу» в главном меню. Откроется наше приложение.
...
✅ **РЕЗУЛЬТАТ**
Вы получаете уверенность в диагнозе и независимую экспертизу (*Second Opinion*), которая помогает вам и вашему врачу выбрать наилучшую стратегию.`,
    {
      parse_mode: "Markdown",
